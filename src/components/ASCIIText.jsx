...
class CanvAscii {
  constructor(
    ...
    // Initialize mouse at center so rotation starts at 0
  ...
  setMesh() {
    ...
    // Initialize rotation to 0 (flat, facing camera)
  ...
  updateRotation() {
    // Map mouse position to rotation, with center being 0
    const targetX = Math.map(this.mouse.y, 0, this.height, 0.3, -0.3);
    const targetY = Math.map(this.mouse.x, 0, this.width, -0.3, 0.3);
